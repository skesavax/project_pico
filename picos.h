 ...
 */
#define PICOS_THREAD(NAME, priority) picos_exec(NAME, &picos_stack_##NAME, priority);
...
/**
 * @brief Describe a context time of cores
 */
typedef struct pico_core_stats_t {
 ...
 */
picos_pid picos_exec(picos_thread_func func, picos_thread_stack_t *stack, uint8_t priority);
